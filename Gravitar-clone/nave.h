...
nave_t *nave_crear(size_t vidas, size_t fuel, enum nivel_enum nivel, char *figura);
...
void nave_setear_nivel(nave_t* nave, enum nivel_enum nivel);
...
enum nivel_enum nave_get_nivel(nave_t * nave);
