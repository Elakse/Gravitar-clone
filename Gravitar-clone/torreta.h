...
//Devuelve una torreta con las características indicadas. Devuelve NULL al fallar.
...
//Randomiza los disparos que se efectuaran durante la ejecución del programa. De no usar la funcion los disparos serán siempre los mismos cada vez que se inicie el programa.
void torreta_randomizar_disparos(void);

//Dispara una bala_t en un angulo <ang>, con un abanico <rango>, probabilidad de <chances>/1000, cierta velocidad <vel>. Se debe indicar también la duracion del disparo y la figura de la bala.
